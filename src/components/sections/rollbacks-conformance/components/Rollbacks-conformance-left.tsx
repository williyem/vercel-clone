import { ArrowLeftRight, RotateCw, Terminal } from "lucide-react";
  ...
  return (
    <div className="space-y-2 basis-1/2 p-12">
      ...
      <div className=" pt-6 relative ">
        <div className=" text-white py-8 space-y-6">
          {/* Previous Deployment (Successful) */}
          <div
            style={{ backgroundClip: "padding-box" }}
            className="relative w-full justify-between items-center  max-w-[323px]  p-4   bg-[var(--ds-background-100)]  text-sm flex  gap-2 rounded-[12px] border border-[var(--ds-gray-alpha-400)] leading-5"
          >
            <div className="flex  flex-col gap-2">
              ...
              <div className="flex items-center gap-2">
                <span className="text-neutral-400">⎇ ba5f55f</span>
                <span className="text-white">Update bento box design</span>
              </div>
            </div>

            <div
              className="absolute right-4 top-4 flex items-center justify-center w-8 h-8 rounded-full font-bold "
              style={{
          ...
          <div
            style={{ backgroundClip: "padding-box" }}
            className="relative w-full ml-auto justify-between items-center border-dashed  max-w-[323px]  p-4   bg-[var(--ds-background-100)]  text-sm flex  gap-2 rounded-[12px] border border-[var(--ds-gray-alpha-400)] leading-5"
          >
            <div className="flex  flex-col gap-2">
              <div className="flex  w-full justify-between">
                <span className="text-neutral-400">
              ...
              <div className="flex items-center gap-2">
                <span className="text-neutral-400">⎇ bx012mm</span>
                <span className="text-white">Fix ESLint error on query</span>
              </div>
            </div>

            <div
              className="absolute right-4 top-4 flex items-center justify-center w-8 h-8 rounded-full font-bold text-red-500"
              style={{
                background: `conic-gradient(
                  #ef4444 0% 55%, 
                  rgba(243, 244, 246, 0.2) 55% 100%
